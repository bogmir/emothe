defmodule Playcode.Places.Place do
  @moduledoc """
  ...
  step and drift silently. `Playcode.Places.display_name/2` picks the one to show.
  ...
  schema "places" do
    ...
    has_many :names, Playcode.Places.PlaceName, on_replace: :delete
