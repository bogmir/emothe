defmodule Emothe.Accounts.UserToken do
  use Ecto.Schema
  import Ecto.Query
  ...
  def by_token_and_context_query(token, context) do
    from Emothe.Accounts.UserToken, where: [token: ^token, context: ^context]
  end
  ...
  def by_user_and_contexts_query(user, :all) do
    from t in Emothe.Accounts.UserToken, where: t.user_id == ^user.id
  end

  def by_user_and_contexts_query(user, [_ | _] = contexts) do
    from t in Emothe.Accounts.UserToken,
