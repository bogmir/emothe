defmodule Playcode.PlayContentTest do
  ...
  describe "shift_element_positions/3" do
    test "shifts positions of elements at and after the given position" do
      ...
      assert Playcode.Repo.get!(Playcode.PlayContent.Element, e1.id).position == 10
      assert Playcode.Repo.get!(Playcode.PlayContent.Element, e2.id).position == 21
      assert Playcode.Repo.get!(Playcode.PlayContent.Element, e3.id).position == 31
    end
    ...
    test "only shifts elements within the same parent" do
      ...
      assert Playcode.Repo.get!(Playcode.PlayContent.Element, c1.id).position == 6
      assert Playcode.Repo.get!(Playcode.PlayContent.Element, c2.id).position == 11
    end
  end
  ...
  describe "shift_line_numbers/2" do
    test "shifts all verse line numbers >= given number in the play" do
      ...
      assert Playcode.Repo.get!(Playcode.PlayContent.Element, v2.id).line_number == 3
      assert Playcode.Repo.get!(Playcode.PlayContent.Element, v3.id).line_number == 4
    end
    ...
    test "preserves split verse groupings (same line_number shifted together)" do
      ...
      assert Playcode.Repo.get!(Playcode.PlayContent.Element, v5i.id).line_number == 6
      assert Playcode.Repo.get!(Playcode.PlayContent.Element, v5f.id).line_number == 6
    end
  end
