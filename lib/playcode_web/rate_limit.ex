defmodule PlaycodeWeb.RateLimit do
  @moduledoc """
  ...
  The ETS table `:playcode_rate_limit` must be created before this module is
  used; it is started in `Playcode.Application.start/2`.
  """

  @table :playcode_rate_limit
