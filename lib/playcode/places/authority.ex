defmodule Playcode.Places.Authority do
  @moduledoc """
  ...
  @registry %{
    "wikidata" => %{
      ...
      module: Playcode.Places.Authority.Wikidata
    },
    "geonames" => %{
      label: "GeoNames",
  ...
  def impl do
    Application.get_env(:playcode, :place_authority, Playcode.Places.Authority.Wikidata)
  end
