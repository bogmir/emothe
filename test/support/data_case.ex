defmodule Playcode.DataCase do
  @moduledoc """
  ...
  by setting `use Playcode.DataCase, async: true`, although
  ...
  def setup_sandbox(tags) do
    pid = Ecto.Adapters.SQL.Sandbox.start_owner!(Playcode.Repo, shared: not tags[:async])
